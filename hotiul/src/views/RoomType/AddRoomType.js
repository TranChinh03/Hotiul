...
function AddRoomType(props) {
	...
	const defaulAmenityList = [
		{ Name: t('roomType.dentalKit'), Quantity: 1 },
		{ Name: t('roomType.comb'), Quantity: 1 },
		{ Name: t('roomType.shampoo'), Quantity: 1 },
		{ Name: t('roomType.bathGel'), Quantity: 1 },
		{ Name: t('roomType.sanitaryBag'), Quantity: 1 },
		{ Name: t('roomType.slipper'), Quantity: 1 },
		{ Name: t('roomType.bed'), Quantity: 1 },
		{ Name: t('roomType.waterHeater'), Quantity: 1 },
		{ Name: t('roomType.airCond'), Quantity: 1 },
	];
	const amenityColumn = [
		{ label: t('roomType.amenityName'), accessor: 'Name' },
		{ label: t('roomType.quantity'), accessor: 'Quantity' },
	];
					...
					<div className="flex flex-row justify-between">
						<div className="text-[34px] ml-6">
							<Input
								...
								size="large"
								placeholder={t('roomType.enterName')}
							/>
						</div>
						...
						<div className="w-80 relative">
							...
							<div className="mt-8 flex float-right absolute bottom-0 right-0">
								<Button
									...
									className="!ml-2 w-24 !text-white !py-2 !px-4 !font-semibold !text-md !normal-case btn-save">
									{t('button.close')}
								</Button>
								<Button
									style={{
